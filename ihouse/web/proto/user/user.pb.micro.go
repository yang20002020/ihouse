...
type UserService interface {
	...
	GetUsrInfo(ctx context.Context, in *UserName, opts ...client.CallOption) (*UserInfoResp, error)
}
...
func (c *userService) GetUsrInfo(ctx context.Context, in *UserName, opts ...client.CallOption) (*UserInfoResp, error) {
	req := c.c.NewRequest(c.name, "User.GetUsrInfo", in)
...
type UserHandler interface {
	...
	GetUsrInfo(context.Context, *UserName, *UserInfoResp) error
}
...
func RegisterUserHandler(s server.Server, hdlr UserHandler, opts ...server.HandlerOption) error {
	type user interface {
		...
		GetUsrInfo(ctx context.Context, in *UserName, out *UserInfoResp) error
	}
	type User struct {
		user
	}
...
func (h *userHandler) GetUsrInfo(ctx context.Context, in *UserName, out *UserInfoResp) error {
	return h.UserHandler.GetUsrInfo(ctx, in, out)
}
